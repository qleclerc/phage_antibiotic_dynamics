...
ggplot(all_results) +
  geom_line(aes(time, Be, colour = "Be"), size = 0.8, alpha = 0.6) +
  geom_line(aes(time, Bt, colour = "Bt"), size = 0.8, alpha = 0.6) +
...
ggsave(here::here("Figures", "fig3.png"), width = 10, height = 7)
...
# ggsave(here::here("Figures", "fig4.png"), width = 10, height = 14)
